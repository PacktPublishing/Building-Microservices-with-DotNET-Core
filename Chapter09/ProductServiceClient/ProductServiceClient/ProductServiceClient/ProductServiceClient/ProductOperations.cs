...
{
    internal partial class ProductOperations : IServiceOperations<ProductServiceClient>, IProductOperations
    {
        /// <summary>
        ...
        /// </param>
        internal ProductOperations(ProductServiceClient client)
        {
            this._client = client;
        }
        ...
        /// </summary>
        public ProductServiceClient Client
        {
